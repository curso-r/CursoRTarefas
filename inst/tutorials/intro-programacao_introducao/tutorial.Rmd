...
- [ ] Faz sentido ter dicas e enviar as respostas depois? as dicas já direcionam para as respostas haha

- [ ] o learnrhash adiciona um botao escrito generate. 

- [ ] Melhorar o css para ficar parecido com a identidade visual da Curso-R

- [ ] ~~Em alguns casos, existem mais de uma forma de resolver os exercícios. Verificar como é possível apontar mais de uma solução aceitável. Por enquanto só entendi como apontar uma solução.~~ `gradethis::grade_this()` possibilita avaliar se os resultados são iguais
