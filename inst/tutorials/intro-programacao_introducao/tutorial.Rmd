...
gradethis::gradethis_setup(
  code_correct =  paste("Correto! ", CursoRTarefas:::frase_acerto()),
  pass = paste("Correto! ", CursoRTarefas:::frase_acerto()),
  fail =  paste("Incorreto. Tente novamente! ", CursoRTarefas:::frase_acerto())
)
